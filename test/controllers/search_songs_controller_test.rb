...
class SearchSongsControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post search_songs_url, params: { search_song: { title: 'New Song', artist_name: 'New Artist', url: 'http://example.com' } }
  #   end
  ...
  #   patch search_song_url(@search_song), params: { search_song: { title: 'Updated Song', artist_name: 'Updated Artist', url: 'http://example.com' } }
